...
jint Java_de_illogical_modo_AytDecoder_aytSysPreset(JNIEnv* env, jclass clazz, jint track)
{
	gme_err_t err = NULL;
	struct gme_info_t* trackinfo;
	int l = -1;
...
jint Java_de_illogical_modo_AytDecoder_aytPlayerVersion(JNIEnv* env, jclass clazz)
{
	gme_err_t err = NULL;
	struct gme_info_t* trackinfo;
	int l = -1;
...
jint Java_de_illogical_modo_AytDecoder_aytFirstsong(JNIEnv* env, jclass clazz)
{
	gme_err_t err = NULL;
	struct gme_info_t* trackinfo;
	int l = -1;
