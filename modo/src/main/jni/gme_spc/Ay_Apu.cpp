...
void Ay_Apu::write_data_( int addr, int data )
{
	...
	// Write only valid data into register, especially register 13 (Envelope shape)
	switch (addr) {
		case 0:
		case 2:
		case 4:
		case 11:
		case 12: data = data &0xff; break;
		case 13:
		case 1:
		case 3:
		case 5: data = data & 0x0f; break;
		case 7: data = data & 63; break;
		case 6:
		case 8:
		case 9:
		case 10: data = data & 31; break;
	};
